...
CREATE TABLE region(
   ...
   connected_to_continental_grid BOOLEAN,
...
CREATE TABLE centrale(
   ...
   minimum_power_fallback_used BOOLEAN,
   values_are_simulated_except_maximum_power BOOLEAN,
   id_1 VARCHAR(50) NOT NULL,
   PRIMARY KEY(id),
   FOREIGN KEY(id_1) REFERENCES region(id)
);
...
CREATE TABLE liaison(
   ...
   available BOOLEAN,
   topology_is_synthetic BOOLEAN,
   capacity_and_loss_are_simulated BOOLEAN,
   id_1 VARCHAR(50) NOT NULL,
